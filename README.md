...
All tutorials follow a consistent style:
- **Language**: German (informal "du"), English versions available
- **Format**: MATLAB Live Scripts (`.mlx`) for German, scripts (`.m`) for English
- **Structure**: Numbered chapters and subchapters with clear table of contents
- **Content**: 
  - 2-3 sentence explanations after code blocks
  - Longer explanations for important topics
  - "EXKURS" (EXCURSUS) sections for deeper dives
  - Hints for common beginner errors
  - Direct visualization explanations ("Du siehst jetzt...")
  - No code gaps to fill (complete code provided)
  - No exercise assignments within tutorials

## Notes

- All tutorials are designed for self-study
- Tutorials 1-2 are required before the block course
- Tutorials 3-8 are optional for interested students
- Code examples use placeholder paths that need to be adjusted
- All "ß" characters are replaced with "ss" (Swiss German convention)

## License

This repository contains educational materials. EEGLAB is released under the GNU Public License (see `Praxis/eeglab2021.1/eeglablicense.txt`).

## Contact

For questions about the tutorials or course materials, please contact the course instructors.
