...
% (An den Ort, in dem das aktuelle Skript gespeichert ist)
...
%Danach wird matlab "eeglab" finden unf öffnen können, jedoch noch nicht 
%alle Funktionen (wie Filter etc.) verwenden können.

% EEGlab öffnen und schliessen (damit werden alle wichtigen Funktionen zum
% Pfad hinzugefügt, d.h. wir können z.B. Filterfunktionen verwenden)
eeglab;
close;
...
% Dieser Befehl schliesst alle Figuren/Abbildungen die geöffnet waren
close all
