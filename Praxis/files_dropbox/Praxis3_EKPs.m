...
subplot(1, 3, 2)
topoplot(mean(GM2(:, a:b), 2),EEGC1.chanlocs,'electrodes','on'); % mean(GM1(:, a:b), 2) => average over time window = [152 : 212]
colorbar;

subplot(1, 3, 3)
topoplot(mean(GM3(:, a:b), 2),EEGC1.chanlocs,'electrodes','on'); % mean(GM1(:, a:b), 2) => average over time window = [152 : 212]
colorbar;
