...
%% Check: Signal processing / Bioinfrmatics toolbox installiert?
...
% EEG.times
% EEG.srate
% EEG.pnts (relation to times, srate tells us 1 sample is 4ms):
% EEG.chanlocs
% EEG.ref
% EEG.event
...
title(['Data rereferenced near left ear, electrode number: ' num2str(chlLeftEar)])

title(['Data rereferenced to right forehead, electrode number: ' num2str(chlRightForehead)])
