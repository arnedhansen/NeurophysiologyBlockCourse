...
%TODO: Daten mit der Funktion "pop_eegfiltnew" filtern
...
%plot time series before and after ICA component removal
FrontalElec=2;
minPnt=2000; maxPnt=5000;

figure;
plot(EEG.data(FrontalElec,minPnt:maxPnt),'b');ylim([-60 110]); hold on;
